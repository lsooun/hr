            ...
            <div class="row">
                ...
                @if ($payslip)
                    <div class="col-sm-4 text-right">
                        ...
                        {{--<button data-toggle="modal" data-target="#send_sms" class="btn btn-complete btn-animated from-left fa fa-mobile-phone">--}}
                        {{--<span>{{language_data('Send SMS')}}</span></button>--}}

                        <button data-toggle="modal" data-target="#send_email" class="btn btn-primary btn-animated from-left fa fa-envelope">
                            <span>{{language_data('Send Email')}}</span></button>
            ...
            <div class="panel">
                @if ($payslip)
                    <div class="panel-heading p-b-none">
                        <h3>{{language_data('Salary Statement')}}<br>
                            <small>{{language_data('Salary Statement')}} {{language_data('For')}}: {{$payslip->employee_info->fname}} {{$payslip->employee_info->lname}}</small>
                        </h3>
                    </div>
                    <div class="panel-body p-none m-b-10">
                        <table class="table table-no-border table-condensed">
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong class="help-split">{{language_data('Date From')}}:</strong>{{get_date_format($date_from)}}
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <strong class="help-split">{{language_data('Date To')}}:</strong>{{get_date_format($date_to)}}
                                </td>
                            </tr>
                            <tr>
                                <td>
                    ...
                    <div class="panel-body p-none m-b-10">
                        <table class="table table-no-border table-condensed">
                            ...
                            <tr>
                                <td>
                                    <br>
                                    <span>在指定的时间范围内没有工资明细。</span>
                                    <br>
                                    <br>
                                    <a href="{{url('reports/payroll')}}" class="btn btn-success btn-animated from-left fa fa-mail-reply-all">
                                        <span>返回</span></a>
                                    <br>
                                    <br>
                                </td>
                            ...
                            <div class="panel-body p-none">
                                <table class="table table-condensed">
                                    ...
                                    @foreach($payroll as $p)
                                        <tr>
                                            <td>
                                                <strong>{{$p->payment_month}}:</strong>
                                                <span class="pull-right">{{app_config('Currency')}} {{$p->total_salary}}</span>
                                            </td>
                                        </tr>
                                    @endforeach
                                ...
                                <table class="table table-condensed">
                                    ...
                                    <tr>
                                        <td><strong>{{language_data('Net Salary')}}:</strong>
                                            <span class="pull-right">{{app_config('Currency')}} {{$net_salary}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong>{{language_data('Overtime Amount')}}:</strong>
                                            <span class="pull-right">{{app_config('Currency')}} {{$over_time}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong>{{language_data('TAX')}}:</strong>
                                            <span class="pull-right">{{app_config('Currency')}} {{$tax}}</span></td>
                                    </tr>
                                    <tr>
                                        <td><strong>{{language_data('Provident Fund')}}:</strong>
                                            <span class="pull-right">{{app_config('Currency')}} {{$provident_fund}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td><strong>{{language_data('Loan')}}:</strong>
                                            <span class="pull-right">{{app_config('Currency')}} {{str_replace('.00','',$loan)}}</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="td-highlighted"><strong>{{language_data('Grand Total')}}:</strong>
                                            <span class="pull-right"><strong>{{app_config('Currency')}} {{$total_salary}}</strong></span>
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
