                ...
                <div class="col-lg-12">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#officeTime" aria-controls="officeTime" role="tab" data-toggle="tab">
                                <i class="fa fa-clock-o"></i> {{language_data('Office Time')}}</a></li>
                        ...
                        <li role="presentation"><a href="#job" aria-controls="job" role="tab" data-toggle="tab"><i
                                        class="fa fa-briefcase"></i> {{language_data('Job Application')}}</a></li>
                    </ul>

                    <div class="tab-content panel p-20">

                        {{--Office Time Tab--}}
                        <div role="tabpanel" class="tab-pane active" id="officeTime">
                            <div class="row">
                                <div class="col-md-7">
                                ...
                                <div class="col-lg-4">
                                    <form class="" role="form" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="help">{{language_data('e.g.')}} "{{language_data('Employee Salary')}}"</span>
                                        ...
                                        @foreach($expense_title as $d)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-success" href="#" data-toggle="modal" data-target=".modal_edit_expense_type_{{$d->id}}"><i class="fa fa-edit"></i> {{language_data('Edit')}}
                                                    </a>
                                                    @include('admin.modal-expense-type')

                                                    <a href="#" class="btn btn-danger deleteExpense" id="{{$d->id}}"><i class="fa fa-trash"></i> {{language_data('Delete')}}
                                                    </a>
                                                </td>
                                            </tr>
                                ...
                                <div class="col-lg-4">
                                    <form class="" role="form" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="help">{{language_data('e.g.')}} "{{language_data('Sick Leave')}}"</span>
                                            <input type="text" class="form-control" required name="leave">
                                        </div>

                                        <div class="form-group">
                                            <label>{{language_data('Leave Quota')}}</label>
                                            <span class="help">{{language_data('e.g.')}} "12" 天</span>
                                ...
                                <div class="col-lg-8">
                                    <table class="table data-table table-hover table-ultra-responsive">
                                        ...
                                        @foreach($leave_type as $d)
                                            <tr>
                                                <td data-label="{{language_data('Leave Type')}}"><p>{{$d->leave}}</p>
                                                </td>
                                                <td data-label="{{language_data('Leave Quota')}}">
                                                    <p>{{$d->leave_quota}}</p></td>
                                                <td>

                                                    <a class="btn btn-success" href="#" data-toggle="modal" data-target=".modal_edit_leave_type_{{$d->id}}"><i class="fa fa-edit"></i> {{language_data('Edit')}}
                                                    </a>
                                                    @include('admin.modal-leave-type')

                                                    <a href="#" class="btn btn-danger deleteLeave" id="{{$d->id}}"><i class="fa fa-trash"></i> {{language_data('Delete')}}
                                                    </a>
                                                </td>
                                            </tr>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <form class="" role="form" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="help">{{language_data('e.g.')}} "{{language_data('Best Employee')}}"</span>
                                ...
                                <div class="col-lg-8">
                                    <table class="table data-table table-hover table-ultra-responsive">
                                        ...
                                        @foreach($award as $d)
                                            <tr>
                                                <td data-label="{{language_data('Award Name')}}"><p>{{$d->award}}</p>
                                                </td>
                                                <td>

                                                    <a class="btn btn-success" href="#" data-toggle="modal" data-target=".modal_edit_award_type_{{$d->id}}"><i class="fa fa-edit"></i> {{language_data('Edit')}}
                                                    </a>
                                                    @include('admin.modal-award-type')

                                                    <a href="#" class="btn btn-danger deleteAward" id="{{$d->id}}"><i class="fa fa-trash"></i> {{language_data('Delete')}}
                                                    </a>
                                                </td>
                                            </tr>
                                ...
                                <div class="col-lg-6">
                                    <form class="" role="form" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="help">{{language_data('e.g.')}}"doc,pdf" {{language_data('Remember: File Extension Separated By Comma')}}</span>
                                        ...
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <button type="submit" class="btn btn-success">
                                            <i class="fa fa-save"></i> {{language_data('Save')}} </button>
                                    </form>
                                </div>
