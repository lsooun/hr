<div class="modal fade modal_send_email" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            ...
            <form class="form-some-up form-block" role="form" action="{{url('reports/send-email-to-applicants')}}" method="post">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" readonly class="form-control" required="" id="email" name="email" value="{{$d->email}}">
                    </div>
                    <br>
                    <div class="form-group">
                ...
                <div class="modal-footer">
                    ...
                    <input type="hidden" id="cmd" name="cmd" value="{{$d->id}}">
