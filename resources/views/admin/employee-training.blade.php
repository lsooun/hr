                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <button class="btn btn-success pull-right" data-toggle="modal" data-target="#add-new-training">
                                <i class="fa fa-plus"></i> {{language_data('Add New Training')}}</button>
                            <br>
                        </div>
                            ...
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                @foreach($emp_training as $et)
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success" href="{{url('training/view-employee-training/'.$et->id)}}"><i class="fa fa-edit"></i> {{language_data('Edit')}}
                                            </a>
