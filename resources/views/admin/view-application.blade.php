                            ...
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                @foreach($applicants as $d)
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <a class="btn btn-complete" style="margin-bottom: 5px" href="{{url('jobs/download-resume/'.$d->id)}}">
                                                <i class="fa fa-download"></i> {{language_data('Resume')}}
                                            </a>

                                            <a class="btn btn-success" style="margin-bottom: 5px" href="#" data-toggle="modal" data-target=".modal_set_job_applicant_status_{{$d->id}}">
                                                <i class="fa fa-edit"></i> {{language_data('Status')}}
                                            </a>
                                            @include('admin.modal-set-status-applicant')

                                            <a  style="margin-bottom: 5px" href="#" class="btn btn-danger cdelete" id="{{$d->id}}">
