    ...
    <div class="container container-printable">
        <div class="p-30 p-t-none p-b-none">
            ...
            <table width="100%">
                <tbody>
                <tr>
                    <td style="border: 0;  text-align: left" width="30%">
                    ...
                    <td style="border: 0;  text-align: right" width="70%">
                        <div>
                            <img src="<?php echo asset(app_config('AppLogo')); ?>" alt="logo" height="22">
                ...
                <tr>
                    <td>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6">
                                <span>{{language_data($payslip->payment_type)}}</span>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-6">
