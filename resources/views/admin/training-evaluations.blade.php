                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                @foreach($training_evaluation as $d)
                                    <tr>
                                        <td data-label="{{language_data('Title')}}"><p>{{$d->training_title->title}}</p></td>
                                        <td>
                                            <a class="btn btn-success" href="#" data-toggle="modal" data-target=".modal_edit_training_evaluations_{{$d->id}}"><i class="fa fa-edit"></i> {{language_data('Edit')}}
                                            </a>
