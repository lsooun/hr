                            ...
                            <form class="" role="form" action="{{url('payroll/edit-employee-salary-increment-post')}}" method="post">
                                ...
                                <div class="show-monthly">
                                    <div class="form-group">
                                        ...
                                        <span class="help">{{language_data('e.g.')}} "5000" ({{language_data('Add with basic salary')}})</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="help">{{language_data('Hourly')}} {{language_data('e.g.')}} "4" ({{language_data('Add with basic salary')}})</span>
                                ...
                                <div class="show-hourly">
                                    <div class="form-group">
                                        ...
                                        <span class="help">{{language_data('e.g.')}} "3" ({{language_data('Add with basic salary')}})</span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="help">{{language_data('e.g.')}} "4" ({{language_data('Add with basic salary')}})</span>
