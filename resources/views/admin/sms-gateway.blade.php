                            ...
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                @foreach($sms_gateway as $sg)
                                    <tr>
                                        ...
                                        <td data-label="Gateway Name"><p>
                                                <a href="{{url('settings/sms-gateways-manage/'.$sg->id)}}"> {{$sg->name}}</a>
                                            </p></td>
                                        @if($sg->status=='Active')
                                        ...
                                        <td data-label="Actions">
                                            <a class="btn btn-success"
                                               href="{{url('settings/sms-gateways-manage/'.$sg->id)}}"><i class="fa fa-edit"></i> {{language_data('Manage')}}
                                            </a>
                                        </td>
                                    </tr>
