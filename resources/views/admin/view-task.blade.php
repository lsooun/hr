                                    ...
                                    <div class="tab-content p-20">
                                        ...
                                        <div role="tabpanel" class="tab-pane active" id="task_details">
                                            ...
                                            @foreach($task_employee as $te)
                                                <a href="{{url('employees/view/'.$te->emp_id)}}" class="text-success text-underline">{{$te->emp_name}}</a>
                                                <br>
                                            @endforeach
                                        </div>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="task_discussion">
                                            ...
                                            <table class="table table-hover table-ultra-responsive">
                                                ...
                                                @foreach($task_comment as $tc)
                                                    <tr>
                                                        <td data-label="{{language_data('Member')}}">
                                                            <p>{{$tc->employee_name->fname}}
                                                        ...
                                                        <td data-label="{{language_data('Comment')}}">
                                                            <p>{{strip_tags($tc->comment)}}</p></td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td data-label="{{language_data('Upload By')}}">
                                                            <p>{{$tf->employee_name->fname}}
                                                                <span class="label label-success">
                                                                    {{$tf->employee_name->employee_role->role_name}}</span>
                                                            </p></td>
                                                        <td>
                                                            <a href="{{url('task/download-file/'.$tf->id)}}" class="btn btn-success"><i class="fa fa-download"></i>
                                                            </a>
