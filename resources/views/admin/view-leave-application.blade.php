                        ...
                        <div class="panel-body">
                            <form class="" role="form" action="{{url('leave/post-job-status')}}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" readonly rows="4">{{strip_tags($leave->leave_reason)}}</textarea>
                                </div>

                                <div class="form-group">
                                    <label>{{language_data('Current Status')}}</label>
                                    {{language_data(ucfirst($leave->status))}}
                                    <input type="hidden" class="form-control" value="{{$leave->status}}" readonly>
                                </div>
