                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <button class="btn btn-success pull-right" data-toggle="modal" data-target="#add-load">
                                <i class="fa fa-plus"></i> {{language_data('Add')}} {{language_data('Loan')}}</button>
                            <br>
                        </div>
                                ...
                                @foreach($loan as $l)
                                    <tr>
                                        ...
                                        <td data-label="{{language_data('Employee Name')}}">
                                            <a href="{{url('employees/view/'.$l->emp_id)}}">{{$l->employee_info->fname}} {{$l->employee_info->lname}}</a>
                                        </td>
                                        <td data-label="{{language_data('Loan')}} {{language_data('Date')}}"><p>{{get_date_format($l->loan_date)}}</p></td>
                                        ...
                                        @endif
                                        <td>
                                            <a class="btn btn-success" href="{{url('loan/view-details/'.$l->id)}}"><i class="fa fa-edit"></i> {{language_data('Edit')}}
                                            </a>
                                            <a href="#" class="btn btn-danger cdelete" id="{{$l->id}}"><i class="fa fa-trash"></i> {{language_data('Delete')}}
                                            </a>
                                        </td>
                                    </tr>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="coder-radiobox radio-inline">
                                            <input type="radio" name="payslip" value="yes" checked><span
                                                    class="co-radio-ui"></span><label>{{language_data('Yes')}}</label>
                                        </div>

                                        <div class="coder-radiobox radio-inline">
                                            <input type="radio" name="payslip" value="no"><span
                                                    class="co-radio-ui"></span><label>{{language_data('No')}}</label>
                                        </div>
                                    </div>
                                </div>
