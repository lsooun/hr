                            ...
                            <form class="" role="form" action="{{url('provident-fund/edit-post')}}" method="post">
                                ...
                                <div class="form-group m-none">
                                    ...
                                    <select name="fund_type" class="form-control selectpicker fundType">
                                        <option value="Fixed Amount" @if($pfund->provident_fund_type=='Fixed Amount') selected @endif>{{language_data('Fixed Amount')}}</option>
                                        <option value="Percentage of Basic Salary" @if($pfund->provident_fund_type=='Percentage of Basic Salary') selected @endif>{{language_data('Percentage of Basic Salary')}}</option>
                                    </select>
                                </div>
