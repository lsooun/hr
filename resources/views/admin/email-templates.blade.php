                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                @foreach($d as $et)
                                    <tr>
                                        <td data-label="{{language_data('Template Name')}}"><p>
                                                <a href="{{url('settings/email-template-manage/'.$et->id)}}">
                                                    {{language_data($et->tplname)}}</a>
                                            </p></td>
                                        ...
                                        <td>
                                            <a class="btn btn-success"
                                               href="{{url('settings/email-template-manage/'.$et->id)}}"><i class="fa fa-edit"></i> {{language_data('Manage')}}
                                            </a>
                                        </td>
                                    </tr>
                                @endforeach
