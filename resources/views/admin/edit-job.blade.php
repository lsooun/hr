                            ...
                            <form class="" role="form" action="{{url('jobs/job-edit-post')}}" method="post">
                                ...
                                <div class="form-group m-none">
                                    ...
                                    <select name="status" class="form-control selectpicker">
                                        <option value="opening" @if($job->status == 'opening') selected @endif>{{language_data('Open')}}</option>
                                        <option value="closed" @if($job->status == 'closed') selected @endif>{{language_data('Closed')}}</option>
                                        <option value="drafted" @if($job->status == 'drafted') selected @endif>{{language_data('Drafted')}}</option>
                                    </select>
                                </div>
