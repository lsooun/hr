                            ...
                            <div class="clearfix">
                                ...
                                <div class="pull-left">
                                    ...
                                    <ul class="info-list">
                                        @if($employee->email!='')
                                            <li>
                                                <span class="info-list-title">{{language_data('Email')}}</span><span class="info-list-des">{{$employee->email}}</span>
                                            </li>
                                        @endif

                                        @if($employee->phone!='')
                                            <li>
                                                <span class="info-list-title">{{language_data('Phone')}}</span><span class="info-list-des">{{$employee->phone}}</span>
                                            </li>
                                        @endif

                                        @if($employee->user_name!='')
                                            <li>
                                                <span class="info-list-title">{{language_data('Username')}}</span><span class="info-list-des">{{$employee->user_name}}</span>
                                            </li>
                                        @endif

                                        @if($employee->pre_address!='')
                                            <li>
                                                <span class="info-list-title">{{language_data('Address')}}</span><span class="info-list-des">{{$employee->pre_address}}</span>
                                            </li>
                                        @endif
                                    </ul>
                                </div>
                ...
                <div class="col-lg-12">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active">
                            <a href="#personal_details" aria-controls="home" role="tab" data-toggle="tab">{{language_data('Personal Details')}}</a>
                        </li>
                        <li role="presentation">
                            <a href="#bank_information" aria-controls="profile" role="tab" data-toggle="tab">{{language_data('Bank Info')}}</a>
                        </li>
                        <li role="presentation">
                            <a href="#document" aria-controls="messages" role="tab" data-toggle="tab">{{language_data('Document')}}</a>
                        </li>
                        <li role="presentation">
                            <a href="#change-picture" aria-controls="settings" role="tab" data-toggle="tab">{{language_data('Change Picture')}}</a>
                        </li>
                    </ul>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="help">{{language_data('e.g.')}} "546814" ({{language_data('Unique For every User')}})</span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="help">{{language_data('e.g.')}} "user"
                                                ({{language_data('Unique For every User')}})</span>
                                            <input type="text" class="form-control" required name="username" value="{{$employee->user_name}}">
                                        </div>

                                        <div class="form-group">
                                            <label>{{language_data('Email')}}</label>
                                            <span class="help">{{language_data('e.g.')}} "hr@mw.life" ({{language_data('Unique For every User')}})</span>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datePicker" required="" name="doj" value="{{$employee->doj}}">
                                        </div>

                                        <div class="form-group">
                                            <label>{{language_data('Date Of Leave')}}</label>
                                            <input type="text" class="form-control datePicker" name="dol" value="{{$employee->dol}}">
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control datePicker" name="dob" value="{{$employee->dob}}">
                                        </div>
                                            ...
                                            <table class="table data-table table-hover table-ultra-responsive">
                                                ...
                                                @foreach($bank_accounts as $ba)
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a href="#" data-toggle="tooltip" data-placement="top" title="Delete" class="btn btn-danger deleteBankAccount" id="{{$ba->id}}"><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                                </tbody>
                                        ...
                                        <div class="panel-body">
                                            <form class="" role="form" method="post" action="{{url('employee/add-document')}}" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span class="help">{{language_data('e.g.')}} "简历，求职信等"</span>
                                            ...
                                            <table class="table data-table table-hover table-ultra-responsive">
                                                ...
                                                @foreach($employee_doc as $ed)
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <a href="{{url('employee/download-employee-document/'.$ed->id)}}" class="btn btn-success"><i class="fa fa-download"></i> {{language_data('Download')}}
                                                            </a>
                                                            <a href="#" class="btn btn-danger deleteEmployeeDoc" id="{{$ed->id}}"><i class="fa fa-trash"></i> {{language_data('Delete')}}
                                                            </a>
                                                        </td>
                                                    </tr>
                                                @endforeach
