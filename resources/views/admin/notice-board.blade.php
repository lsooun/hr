                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <button class="btn btn-success pull-right" data-toggle="modal" data-target="#add-new-notice">
                                <i class="fa fa-plus"></i> {{language_data('Add New Notice')}}</button>
                            <br>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        @if($d->status=='Published')
                                            <td data-label="{{language_data('Status')}}">
                                                <p class="bold text-success text-underline">{{language_data('Published')}}</p>
                                            </td>
                                        @else
                                            <td data-label="{{language_data('Status')}}">
                                                <p class="bold text-warning text-underline">{{language_data('Unpublished')}}</p>
                                            </td>
                                        @endif

                                        <td>
                                            <a class="btn btn-success" href="{{url('notice-board/edit/'.$d->id)}}"><i class="fa fa-edit"></i> {{language_data('Edit')}}
                                            </a>
