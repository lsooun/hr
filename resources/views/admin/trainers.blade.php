                ...
                <div class="col-lg-12">
                    <div class="panel">
                        <div class="panel-heading">
                            <button class="btn btn-success pull-right" data-toggle="modal" data-target="#add-new-trainer">
                                <i class="fa fa-plus"></i> {{language_data('Add New Trainer')}}</button>
                            <br>
                        </div>
                        <div class="panel-body p-none">
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                @foreach($trainers as $d)
                                    <tr>
                                        <td data-label="{{language_data('Name')}}"><p>{{$d->first_name}} {{$d->last_name}}</p></td>
                                        <td data-label="{{language_data('Email')}}"><p>{{$d->email_address}}</p></td>
                                        <td data-label="{{language_data('Designation')}}"><p>{{$d->designation}}</p></td>
                                        <td data-label="{{language_data('Organization')}}"><p>{{$d->organization}}</p></td>
                                        <td class="text-right">
                                            <a class="btn btn-success" href="{{url('training/view-trainers-info/'.$d->id)}}"><i class="fa fa-edit"></i> {{language_data('Edit')}}
                                            </a>
