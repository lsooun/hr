...
@section('content')
    ...
    <section class="wrapper-bottom-sec">
        <div class="p-30">
            <h2 class="page-title">{{language_data('Employee Salary List')}}</h2>
        </div>
                            ...
                            <table class="table data-table table-hover table-ultra-responsive">
                                ...
                                @foreach($employee as $d)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a class="btn btn-success" href="{{url('payroll/employee-salary-edit/'.$d->id)}}"><i class="fa fa-edit"></i> {{language_data('Edit')}}
                                            </a>
                                        </td>
                                    </tr>
