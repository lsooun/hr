                            ...
                            <form role="form" action="{{url('expense/expense-edit-post')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group m-none">
                                    ...
                                    <select name="status" class="form-control selectpicker">
                                        <option value="Pending" @if($expense->status=='Pending') selected @endif>
                                            {{language_data('Pending')}}
                                        </option>
                                        <option value="Approved"  @if($expense->status=='Approved') selected @endif>
                                            {{language_data('Approved')}}
                                        </option>
                                        <option value="Cancel"  @if($expense->status=='Cancel') selected @endif>
                                            {{language_data('Cancel')}}
                                        </option>
                                    </select>
                                </div>
                                ...
                                <button type="submit" class="btn btn-success pull-right"><i class="fa fa-edit"></i> {{language_data('Update')}} </button>
                            </form>
                        </div>
                    </div>
                </div>
