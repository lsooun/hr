                ...
                <div class="col-lg-12">
                    ...
                    <div class="tab-content panel p-20">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="personal_details">
                            <form role="form" method="post" action="{{url('user/post-user-personal-info')}}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="help">{{language_data('e.g.')}} "hr@mw.life"
                        ...
                        <div role="tabpanel" class="tab-pane" id="change-picture">
                            <form role="form" action="{{url('user/update-user-avatar')}}" method="post" enctype="multipart/form-data">
