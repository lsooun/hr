                    ...
                    <!-- Job Card Start -->
                        <div class="panel cp-clickable cp-linkable panel-hoverd panel-30">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title panel-title-15">
                                    <a href="{{url('apply-job/details/'.$j->id)}}">{{$j->position_name->designation}}</a>
                                </h3>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 col-md-12">
                                        <ul class="info-list title-space-md">
                                            <li><span class="info-list-title">{{language_data('Number Of Post')}}</span><span class="info-list-des">{{$j->no_position}}</span>
                                            </li>
                                            <li>
                                                <span class="info-list-title">{{language_data('Experience')}}</span><span class="info-list-des">{{$j->experience}}</span>
                                            </li>
                                            <li>
                                                <span class="info-list-title">{{language_data('Deadline')}}</span><span class="info-list-des">{{get_date_format($j->apply_date)}}</span>
                                            </li>
                                        </ul>
                                    </div>
