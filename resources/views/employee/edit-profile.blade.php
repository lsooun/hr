                            ...
                            <div class="clearfix">
                                <div class="pull-left m-r-30">
                                    <div class="thumbnail m-b-none">
                                        ...
                                        @if($employee->avatar!='')
                                            <img src="<?php echo asset('assets/employee_pic/' . $employee->avatar); ?>" alt="Profile Page" width="200px">
                                        @else
                                            <img src="<?php echo asset('assets/employee_pic/user.png');?>" alt="Profile Page" width="200px">
                                        @endif
                                    </div>
                                </div>
                                <div class="pull-left">
