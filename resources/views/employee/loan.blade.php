                                ...
                                @foreach($loan as $l)
                                    <tr>
                                        ...
                                        <td data-label="{{language_data('Date')}}">
                                            <p>{{get_date_format($l->loan_date)}}</p></td>
                                        ...
                                        @else
                                            <td data-label="{{language_data('Status')}}">
                                                <p class="bold text-complete text-underline">{{language_data('Completed')}}</p>
                                            </td>
                                        @endif
                                        <td>
                                            @if($l->status=='pending')
                                                <a class="btn btn-success" href="{{url('employee/loan/view-details/'.$l->id)}}"><i class="fa fa-edit"></i> {{language_data('Edit')}}
                                                </a>
                                            @endif
                                        </td>
                                    </tr>
            ...
            <div class="modal fade" id="add-load" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form class="form-some-up" role="form" method="post" action="{{url('employee/loan/post-new-loan')}}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <div class="coder-radiobox radio-inline">
                                            <input type="radio" name="payslip" value="yes" checked>
                                            <span class="co-radio-ui"></span><label>{{language_data('Yes')}}</label>
                                        </div>

                                        <div class="coder-radiobox radio-inline">
                                            <input type="radio" name="payslip" value="no">
                                            <span class="co-radio-ui"></span><label>{{language_data('No')}}</label>
                                        </div>
                                    </div>
                                </div>
