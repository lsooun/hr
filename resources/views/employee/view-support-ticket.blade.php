                                    ...
                                    <div class="tab-content p-20">
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="ticket_files">
                                            ...
                                            <table class="table table-hover table-ultra-responsive">
                                                <thead>
                                                <tr>
                                                    <th style="width: 25%;">{{language_data('File Title')}}</th>
                                                ...
                                                @foreach($ticket_file as $tf)
                                                    <tr>
                                                        ...
                                                        <td data-label="{{language_data('Size')}}"><p>{{$tf->file_size/1000}} KB</p></td>
                                                        ...
                                                        <td>
                                                            <a href="{{url('employee/support-ticket/download-file/'.$tf->id)}}" class="btn btn-success"><i class="fa fa-download"></i>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                @endforeach
