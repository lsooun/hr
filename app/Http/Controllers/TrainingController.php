...
class TrainingController extends Controller {
  ...
  public function viewTrainersInfo($id) {
    ...
    if ($trainer) {
      ...
      return redirect('training/trainers')->with([
        'message' => 'Trainer info not found',
        'message_important' => true
      ]);
    }
  }
  ...
  public function postNewTraining(Request $request) {
    ...
    $v = \Validator::make($request->all(), [
      'employee' => 'required', 'training_type' => 'required',
      'training_subject' => 'required', 'training_nature' => 'required', 'training_title' => 'required'
    ]);
    $niceNames = array(
      'employee' => '员工',
      'training_type' => '培训类型',
      'training_subject' => '培训主题',
      'training_nature' => '培训性质',
      'training_title' => '培训标题'
    );
    $v->setAttributeNames($niceNames);
    if ($v->fails()) {
    ...
    $emp_training->training_from = $request->training_from;
    $emp_training->training_to = $request->training_to;
  ...
  public function viewEmployeeTraining($id) {
    ...
    if ($emp_train) {
      ...
      return redirect('training/employee-training')->with([
        'message' => 'Employee training info not found',
        'message_important' => true
      ]);
    }
  }
  ...
  public function postNewTrainingNeedsAssessment(Request $request) {
    ...
    $v = \Validator::make($request->all(), [
      'employee' => 'required', 'training_type' => 'required',
      'training_subject' => 'required', 'training_nature' => 'required', 'training_title' => 'required', 'status' => 'required'
    ]);
    $niceNames = array(
      'employee' => '员工',
      'training_type' => '培训类型',
  ...
  public function viewTrainingNeedsAssessment($id) {
    ...
    if ($tnassessment) {
      ...
      return redirect('training/training-needs-assessment')->with([
        'message' => 'Training needs assessment info not found',
        'message_important' => true
      ]);
    }
  }
  ...
  public function postNewTrainingEvent(Request $request) {
    ...
    $v = \Validator::make($request->all(), [
      'employee' => 'required', 'trainer' => 'required',
      'training_type' => 'required', 'training_subject' => 'required',
      'training_nature' => 'required', 'training_title' => 'required', 'status' => 'required'
    ]);
    $niceNames = array(
      'employee' => '员工',
      'trainer' => '教员',
    ...
    $training_event->training_from = $request->training_from;
    $training_event->training_to = $request->training_to;
  ...
  public function viewTrainingEvent($id) {
    ...
    if ($training_event) {
      ...
      return redirect('training/training-events')->with([
        'message' => 'Training event info not found',
        'message_important' => true
      ]);
    }
  ...
  public function updateTrainingEvaluations(Request $request) {
    ...
    if ($training_evaluation) {
      ...
      return redirect('training/evaluations')->with([
        'message' => 'Training evaluation updated'
      ]);
    } else {
      return redirect('training/evaluations')->with([
        'message' => 'Training evaluation info not found',
        'message_important' => true
      ]);
    }
